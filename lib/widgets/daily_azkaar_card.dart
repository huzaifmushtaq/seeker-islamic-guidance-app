    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: const LinearGradient(
          ...
          colors: [Color(0xffF6EFD9), Color(0xffF2E4BE)],
        ),
        boxShadow: [
          BoxShadow(
      ...
      child: Column(
        ...
        children: [
              ...
              if (!isLoading && currentAzkar != null)
                Container(
                  ...
                  child: Text(
                    currentAzkar == null
                        ? ""
                        : "${(currentAzkar!.targetCount - currentCount).clamp(0, currentAzkar!.targetCount)} Left",
                ...
                children: [
                  ...
                  if (isLong) ...[
                    ...
                    GestureDetector(
                      onTap: () {
                        setState(() {
                          _showFullAzkar = !_showFullAzkar;
                        });
                      },
                      child: Text(
                        _showFullAzkar ? "Hide Azkar ↑" : "See full Azkar ↓",
                        style: const TextStyle(
                          color: Color(0xff0E5A56),
                          fontSize: 13,
                          fontWeight: FontWeight.w700,
              ...
              Expanded(
                child: ClipRRect(
                  ...
                  child: LinearProgressIndicator(
                    value:
                        currentAzkar == null || currentAzkar!.targetCount == 0
                        ? 0
                        : currentCount / currentAzkar!.targetCount,
                    minHeight: 8,
                    backgroundColor: Colors.white,
                    valueColor: AlwaysStoppedAnimation(Color(0xff0E5A56)),
                  ),
                ),
              ),
          ...
          if (currentAzkar != null && currentCount >= currentAzkar!.targetCount)
            const Padding(
