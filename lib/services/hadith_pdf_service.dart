...
class HadithPdfService {
  Future<void> generate({
        ...
        build: (context) => [
          ...
          pw.Center(
            child: pw.Text(
              ...
              style: pw.TextStyle(font: englishBold, fontSize: 18),
            ),
          ),
          ...
          pw.Center(
            child: pw.Text(chapter, style: pw.TextStyle(font: englishFont)),
          ),
          ...
          if (narrator.isNotEmpty)
            pw.Text(arabic, style: pw.TextStyle(font: englishBold)),
          ...
          pw.Text(
            "Hadith #$hadithNumber",
            style: pw.TextStyle(font: englishBold),
          ),
    ...
    final file = File("${directory.path}/hadith.pdf");
