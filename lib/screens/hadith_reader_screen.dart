...
class _HadithReaderScreenState extends State<HadithReaderScreen> {
  final HadithReaderRepository _repository = HadithReaderRepository();
  final HadithProgressService _progress = HadithProgressService();
  final HadithBookmarkService _bookmarkService = HadithBookmarkService();
  final PageController _pageController = PageController();
  final HadithPdfService _pdfService = HadithPdfService();
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              label,
              style: const TextStyle(fontSize: 12, color: Color(0xff12372A)),
            ),
          ],
        ),
      ),
  ...
  Future<void> _loadBookmark() async {
    ...
    isBookmarked = await _bookmarkService.isBookmarked(hadiths[currentPage].id);
          ...
          body: SafeArea(
            child: Column(
              children: [
                ...
                Text(
                  widget.collection.replaceAll("_", " ").toUpperCase(),
                  style: const TextStyle(
                    letterSpacing: 2,
                      ...
                      return SingleChildScrollView(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(color: const Color(0xffDCCDAA)),
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  _action(Icons.copy_rounded, "Copy", () async {
...
''';
                                  ...
                                  _action(
                                    ...
                                    () async {
                                      final fits =
                                          ShareLayoutService.fitsInImage(
                                            arabic: hadiths[currentPage].arabic,
                                            narrator:
                                                hadiths[currentPage].narrator,
                                            english:
                                                hadiths[currentPage].english,
                                          );
