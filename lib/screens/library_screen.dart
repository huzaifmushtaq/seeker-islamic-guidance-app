            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/images/library-top.png'),
                  fit: BoxFit.cover,
                ),
              ),
            ...
            Padding(
              ...
              child: GridView.count(
                ...
                children: [
                  ...
                  _categoryCard("assets/icons/L5.png", "Duas", "Supplications"),
...
Widget _categoryCard(String iconPath, String title, String subtitle) {
  return Container(
    padding: const EdgeInsets.all(16),
...
Widget _bookCard(String image, String title, String author) {
  return Container(
    width: 90,
    ...
    child: Column(
      ...
      children: [
        ClipRRect(
          ...
          child: Image.asset(image, height: 150, width: 130, fit: BoxFit.cover),
        ),
