...
class LoginScreen extends StatefulWidget {
  ...
  const LoginScreen({super.key, this.startWithLogin = true});
                    ...
                    child: Column(
                      children: [
                        AnimatedSwitcher(
                          ...
                          child: Text(
                            isLogin ? "Assalamu Alaikum" : "Begin Your Journey",
  ...
  return Padding(
    ...
    child: TextFormField(
      ...
      decoration: InputDecoration(
        ...
        hintStyle: const TextStyle(color: Color(0xFF9EB3B3)),
        ...
        prefixIcon: Icon(icon, color: const Color(0xFFF4D17D)),
        ...
        enabledBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(16),
          borderSide: const BorderSide(color: Color(0x22F4D17D), width: 1),
        ),

        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(16),
          borderSide: const BorderSide(color: Color(0xFFF4D17D), width: 1.5),
        ),
        ...
        focusedErrorBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(16),
          borderSide: const BorderSide(color: Color(0xFFF4D17D), width: 2),
        ),
      ),
    ),
  );
  ...
  return InkWell(
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(16),
        border: Border.all(color: const Color(0x22F4D17D)),
      ),

      child: Row(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Icon(icon, color: const Color(0xFFF4D17D)),
