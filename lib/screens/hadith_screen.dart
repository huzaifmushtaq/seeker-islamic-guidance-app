...
class _HadithScreenState extends State<HadithScreen> {
  String searchQuery = "";
  final HadithLibraryRepository _repository = HadithLibraryRepository();
            ...
            children: [
              ...
              ContinueHadithCard(
                collectionName: lastRead == null
                    ? "Start Reading"
                    : _collectionTitle(lastRead!["collection"] as String),
                  ...
                  return HadithCollectionCard(
                    ...
                    onTap: () async {
                      await Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (_) => HadithBooksScreen(collection: item),
                        ),
                      );
