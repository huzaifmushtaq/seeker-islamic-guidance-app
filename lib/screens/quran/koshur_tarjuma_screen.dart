...
import 'koshur_tarjuma_reader_screen.dart';

class KoshurTarjumaScreen extends StatefulWidget {
  const KoshurTarjumaScreen({super.key});

  @override
  State<KoshurTarjumaScreen> createState() =>
      _KoshurTarjumaScreenState();
}

class _KoshurTarjumaScreenState
    extends State<KoshurTarjumaScreen> {
