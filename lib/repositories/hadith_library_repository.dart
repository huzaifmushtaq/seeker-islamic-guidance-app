...
class HadithLibraryRepository {
  ...
  static final HadithLibraryRepository _instance = HadithLibraryRepository._();
  ...
  Future<Map<String, dynamic>> loadCollectionMetadata(String collection) async {
  ...
  Future<List<HadithCollectionModel>> loadCollections() async {
    ...
    for (final collection in collections) {
      final metadata = await loadCollectionMetadata(collection);
